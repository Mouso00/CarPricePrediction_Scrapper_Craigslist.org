...
#Remove 'lat' and 'long' columns, substitute remaining missing values with 
#random variable based on current probability of its unique items.
...
cond_prob = pd.DataFrame(list(data_copy.condition.value_counts(normalize=True).items()),columns
                         = ['condition','prob'])
cond_prob
...
# =============================================================================
#Cleaned data can now be used for content-based recommender system, recommendations 
#based on vehicle features similarity, not user preference or profile.
